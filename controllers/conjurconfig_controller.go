...
//+kubebuilder:rbac:groups=conjur.cyberark.com,resources=conjurconfigs,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=conjur.cyberark.com,resources=conjurconfigs/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=conjur.cyberark.com,resources=conjurconfigs/finalizers,verbs=update
...
func (r *ConjurConfigReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&conjurv1alpha1.ConjurConfig{}).
		Owns(&v1.ConfigMap{}).
